...
def generate_customers(output_location_root, number_of_customers, return_data=True):
    customers = []
    with open(f'{output_location_root}/customers.csv', mode='w',newline='') as customers_file:
...
def generate_products(output_location_root, products_to_generate):
    ...
    with open(f'{output_location_root}/products.csv', mode='w',newline='') as products_file:
